...
try:
    ...
    # camera.Connect()
    camera.f.ExposureTime.Set(150000)
        ...
        if not img.IsEmpty():
            ...
            if save_image:
                ...
                if  empty_tray_status!=True:
                    ...
                    # saving frame in casting_img folder
                    cv2.imwrite('C:\\Users\\cspsaa\\Documents\\hzl_pipeline\\casting_img\\cast_'+current_time+'_'+str(genericCounter)+".jpg",imgarray)
                    
                    # saving frame
                    cv2.imwrite('C:\\Users\\cspsaa\\Documents\\hzl_pipeline\\cast_img\\cast_'+current_time+'_'+str(genericCounter)+".jpg",imgarray)
