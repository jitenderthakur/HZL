...
try:
    ...
    # camera.Connect()
    camera.f.ExposureTime.Set(25500)#14000
    ...
    #or cnt in range(0, 200):
        ...
        if not img.IsEmpty():
            ...
            if save_image:
                ...
                print('legged_ingot_status',legged_ingot_status)
                ...
                #saving frame in stacking_img folder
                ...
                #saving frame 
                cv2.imwrite('C:\\Users\\cspsaa\\Documents\\hzl_pipeline\\stack_img\\stack_'+current_time+'_'+str(genericCounter)+'_'+str(batch)+'_'+str(ingot_count)+".jpg",imgarray)
                algo8_python_logger.info({"message": "saving images in stacking folder"})
